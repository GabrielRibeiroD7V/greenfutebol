...
import { Loader2, User, Calendar, Clock, ChevronLeft, AlertCircle, TrendingUp, Info, Hash, Activity, History } from "lucide-react";
...
function AdminTicketDetailPage() {
    ...
    if (loading) {
        return (<div className="flex flex-col items-center justify-center min-h-screen bg-slate-50">
    ...
    if (!ticket) {
        return (<div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center justify-center text-center">
    ...
    return (<div className="min-h-screen bg-slate-50 text-slate-900 p-4 md:p-8 font-sans">
      <div className="max-w-5xl mx-auto">
        <button onClick={() => navigate({ to: '/admin/bilhetes' })} className="flex items-center gap-2 text-slate-500 hover:text-emerald-600 font-black uppercase tracking-widest text-[10px] mb-6 transition-colors">
          <ChevronLeft size={14}/>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
          ...
          <div className="flex gap-3">
             <Button variant="outline" className="border-slate-200 text-slate-600 font-black uppercase text-[10px] tracking-widest" onClick={() => navigate({ to: '/admin/resultados' })}>
               Ver Resultados
             </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="divide-y divide-slate-100">
                {ticket.ticket_selections?.map((sel, idx) => (<div key={idx} className="p-6 space-y-4 hover:bg-slate-50/30 transition-colors">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {sel.parameter_snapshot && (<span className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded font-black uppercase tracking-wider">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between pt-2 border-t border-slate-50 gap-4">
                      ...
                      <div className={cn("px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border self-start md:self-center", sel.settlement_status === 'WON' ? "bg-emerald-50 text-emerald-600 border-emerald-100" :
            ...
            {/* Audit Log */}
            {auditLogs.length > 0 && (<section className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    {auditLogs.map((log, idx) => (<div key={idx} className="flex gap-4">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
               ...
               {ticket.status === 'CONFIRMED' ? (<div className="flex flex-col items-center py-4 text-center">
