        ...
        <div className="mx-auto max-w-5xl px-4 py-8 md:px-6">
          <header className="mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-500">Partidas acontecendo agora</p>
            </div>
          </header>
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white py-24 text-center">
            ...
            <h3 className="text-lg font-bold text-slate-900">Sem partidas ao vivo</h3>
            <p className="max-w-xs text-sm font-medium text-slate-500">
              Não há partidas acontecendo no momento. Confira a agenda de próximos jogos.
            </p>
          </div>
        </div>
      </main>
