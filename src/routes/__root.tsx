...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GreenSport - Apostas Esportivas" },
      { name: "description", content: "A melhor plataforma de apostas esportivas" },
      { name: "author", content: "GreenSport" },
      { property: "og:title", content: "GreenSport" },
      { property: "og:description", content: "A melhor plataforma de apostas esportivas" },
